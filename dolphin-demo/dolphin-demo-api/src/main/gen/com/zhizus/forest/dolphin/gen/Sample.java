package com.zhizus.forest.dolphin.gen; /**
...
public class Sample {
                ...
                return new AsyncMethodCallback<String>() {
                    ...
                    public void onError(Exception e) {
                        ...
                        hello_result result = new hello_result();
                        {
                            ...
                            msg = (TBase) new TApplicationException(TApplicationException.INTERNAL_ERROR, e.getMessage());
                        }
                        try {
    ...
    public static class hello_args implements TBase<hello_args, hello_args._Fields>, java.io.Serializable, Cloneable, Comparable<hello_args> {
        ...
        public int compareTo(hello_args other) {
            ...
            if (isSetPara()) {
                lastComparison = TBaseHelper.compareTo(this.para, other.para);
                if (lastComparison != 0) {
                    return lastComparison;
                }
            }
    ...
    public static class hello_result implements TBase<hello_result, hello_result._Fields>, java.io.Serializable, Cloneable, Comparable<hello_result> {
    ...
    public static class ping_args implements TBase<ping_args, ping_args._Fields>, java.io.Serializable, Cloneable, Comparable<ping_args> {
    ...
    public static class ping_result implements TBase<ping_result, ping_result._Fields>, java.io.Serializable, Cloneable, Comparable<ping_result> {
